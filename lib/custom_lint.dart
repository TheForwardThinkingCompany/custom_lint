...
export 'src/custom_lint_core.dart';
...
void _renderLints(
  ...
  errors = errors.sorted((a, b) {
    final fileCompare = _relativeFilePath(a.location.file, workingDirectory).compareTo(_relativeFilePath(b.location.file, workingDirectory));
