...
class ExpectLint {
  ...
  static const _code = LintCode(
    ...
    problemMessage: 'Expected to find the lint {0} on next line but none found.',
  ...
  void run(
    ...
    final allExpectedLints = expectLints.map((e) => _ComparableExpectLintMeta(e.line, e.code)).toSet();
