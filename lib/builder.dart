...
extension on LibraryElement {
  Element? findElementWithNameFromPackage(String name) {
    return library.importedLibraries.map((e) => e.exportNamespace.get(name)).firstWhereOrNull((element) => element != null);
  }

  ClassElement? _findAstVisitor() {
    return findElementWithNameFromPackage('GeneralizingAstVisitor') as ClassElement?;
  }
}
...
''');
    ...
    for (final visitorMethod in visitor.methods.where((e) => e.name.startsWith('visit'))) {
